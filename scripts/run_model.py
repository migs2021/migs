...
parser.add_argument('--checkpoint', default='checkpoints_expr52/daytime_rainy_highway_5_shot/checkpoint_model.pt')
parser.add_argument('--scene_graphs_json', default='scene_graphs/bdd.json')
